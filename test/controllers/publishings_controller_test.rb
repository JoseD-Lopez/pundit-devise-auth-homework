...
class PublishingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publishing" do
    assert_difference('Publishing.count') do
      post publishings_url, params: { publishing: { author_id: @publishing.author_id, date: @publishing.date, name: @publishing.name, price: @publishing.price } }
    end
  ...
  test "should update publishing" do
    patch publishing_url(@publishing), params: { publishing: { author_id: @publishing.author_id, date: @publishing.date, name: @publishing.name, price: @publishing.price } }
